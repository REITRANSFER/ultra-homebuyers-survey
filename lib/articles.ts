...
export const ARTICLES: ArticleMeta[] = [
  {
    ...
    title:
      "What Actually Happens After You Ask Ultra For a Cash Offer (Most Owners Are Surprised)",
    teaser:
      "A calm, step-by-step look at the whole process, so there are no surprises and no pressure at any point.",
    image: "/images/adv-keys-couple.jpg",
  },
  {
    slug: "/articles/the-truth-about-lowball-offers",
    title:
      "The Truth About 'Lowball' Cash Offers, From People Who Actually Write Them",
    teaser:
  ...
  },
  {
    ...
    title:
      "How to Spot a Real Local Home Buyer From a Tire-Kicker in About Five Minutes",
    teaser:
      "A simple five-point check to vet any cash buyer and protect yourself before you ever sign anything.",
    image: "/images/adv-local-team.jpg",
  },
  {
    slug: "/articles/cash-offer-vs-agent",
    title:
      "Cash Offer or List With an Agent? An Honest Look at What You Truly Walk Away With",
    teaser:
      "A fair side-by-side of both routes, so you can pick the one that fits your home and your life.",
  ...
  },
  {
    ...
    teaser:
      "No repairs, no fees, no showings. Here is where the money actually comes from, and the real trade you make.",
    image: "/images/adv-couple-kitchen.jpg",
  },
  {
    slug: "/articles/fix-up-before-selling",
    title:
      "Should You Fix Up the House Before You Sell It? The Math Most Owners Get Wrong",
    teaser:
  ...
  },
  {
    ...
    teaser:
      "Five plain questions any honest buyer will answer without flinching, so you can keep yourself safe.",
