...
// - "Text Us"  -> opens the prospect's SMS app, pre-addressed to Ultra, pre-filled
//   with the keyword (default "OFFER") so they just hit send.
// - "Call Now" -> tel: link to Ultra.
...
export function ContactCTA({
  ...
  return (
    <div className="my-10 rounded-[14px] border-2 border-[#1a3d6b] bg-[#f4f7fb] px-6 py-8 text-center max-w-[620px] mx-auto">
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-center">
        ...
        <a
          ...
          className="inline-flex items-center justify-center gap-2 bg-[#1a3d6b] hover:bg-[#0f2440] text-white font-extrabold text-[17px] px-6 py-4 rounded-[10px] transition-colors no-underline"
        >
          📞 Call {phoneDisplay}
        </a>
      </div>
