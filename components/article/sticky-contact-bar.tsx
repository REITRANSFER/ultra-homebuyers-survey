    ...
    >
      <div className="mx-auto flex max-w-[760px] items-center gap-2 px-3 py-2.5 sm:gap-3 sm:px-4 sm:py-3">
        ...
        <a
          ...
          className="flex flex-1 items-center justify-center gap-2 rounded-[10px] bg-[#1a3d6b] px-4 py-3 text-[15px] font-extrabold text-white no-underline transition-colors hover:bg-[#0f2440] sm:text-[16px]"
        >
