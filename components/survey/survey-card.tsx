            ...
            <div className="flex flex-col gap-3">
              <div>
                <Input
                  ...
                  className={`h-12 rounded-xl border-gray-200 bg-white text-gray-900 placeholder:text-gray-400 focus:border-[#1a3d6b] focus:ring-[#1a3d6b]/20 ${validationErrors.name ? "border-red-500" : ""}`}
                />
              ...
              <div>
                <Input
                  ...
                  className={`h-12 rounded-xl border-gray-200 bg-white text-gray-900 placeholder:text-gray-400 focus:border-[#1a3d6b] focus:ring-[#1a3d6b]/20 ${validationErrors.email ? "border-red-500" : ""}`}
                />
              ...
              <div>
                <Input
                  ...
                  maxLength={14}
                  className={`h-12 rounded-xl border-gray-200 bg-white text-gray-900 placeholder:text-gray-400 focus:border-[#1a3d6b] focus:ring-[#1a3d6b]/20 ${validationErrors.phone ? "border-red-500" : ""}`}
                />
